...
class StadiumModelTests(unittest.TestCase):
    ...
    def test_position_edit_preserves_opaque_payload(self):
        ...
        moved = StadiumFlag(MusicalPosition(27, 1, 0), flag.payload, flag.original)

        self.assertEqual(moved.render(), "027-01.000|MIDI_CC;CHORUS;4;CC;3;69;1")
